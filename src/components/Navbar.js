      ...
      <nav className="grid grid-flow-col bg-orange-600 w-full">
        ...
        <div className="flex justify-end text-xl py-2 p-5">
          <input
            ...
            value={searchQuery} // Use searchQuery state instead of searchInput
            onChange={(e) => setSearchQuery(e.target.value)} // Update searchQuery state
          />
          <button
            className="bg-red-600 text-white font-bold py-2 px-4 rounded-lg border-b-4"
            onClick={() => handleSearch(searchQuery)} // Pass the searchQuery to handleSearch
          >
            Search
          </button>
        </div>
